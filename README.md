...
## Installation
The application is compatible with Windows, MacOS and Linux. Installers for the platforms are available in the [releases](https://github.com/Armando-Cierra/color-ramp-builder/releases) section.

### ⚠️ macOS: "App is damaged" error?
Open Terminal and run:
```bash
xattr -cr "/Applications/Color Ramp Builder.app"
```
Then open the app normally. [More details](./INSTALL_MAC.md)
